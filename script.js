...
let quoteArray = [
        "your kindness, laughter, and support are just a few reasons I love you 🎂🎉😘💕. On your special day, I'm deeply grateful for your love 🎂🎁🎈 and companionship. ❤❤❤",
        "Happy Birthday,🎈🥳 Your sweetness 🍯, laughter 😄, and love 💖 make my life so special. Every day with you is a blessing 🌸. Celebrating you today and always! 🎂🎉😘💕",
        "Happy Birthday,🎉🌹 Your sparkle ✨, joy 😊, and love 💞 brighten my life. You make every moment magical 🦄. Today is all about celebrating you! 🎂🎁🎈 Love you tons! 😘💕🌟",
        "Happy Birthday,🌟 Your love, laughter, and warmth fill my heart with joy. Every day with you is a gift. Today, I celebrate you and all the happiness you bring into my life. Love you endlessly! ❤❤❤",
    ...
    for(let m = 0; m < musicArray.length; m++)
        {
            let dynamicSwiper = `<div targetMusic = ${m+1} class="swiper-slide mini-music-player-songs" onclick = "targetSong(this)">
                                    <div class="mini-music-player-songs-insides">
                                        <img src='imgs/${musicArray[m].img}.jpeg' class="song-img">
